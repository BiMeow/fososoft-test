...
export let newsContent = [
		...
		content: (
			<>
				<figure className="image">
					<img src="/images/news-detail-1.jpg" alt="" />
				...
				<ul>
					...
					<li>
						<span className="text-[#15AA7A]">Seiso</span> (Sạch sẽ)
					</li>
					<li>
						<span className="text-[#15AA7A]">Seiton</span> (Trật tự)
					</li>
					<li>
						<span className="text-[#15AA7A]">Shitsuke</span> (Kỷ luật)
					</li>
					<li>
						<span className="text-[#15AA7A]">Seiketsu</span> (Tiêu chuẩn hóa)
					</li>
				</ul>
			</>
		),
	...
	},
	{
		...
		content: (
			<>
				<figure className="image">
					<img src="/images/news-detail-2.jpg" alt="" />
		...
		listSub: [
			{
				...
				content: (
					<>
						<h3>3.1 Cải thiện rõ nét môi trường làm việc</h3>
						<p>
			...
			},
			{
				...
				content: (
					<>
						<h3>3.2 Tiết kiệm thời gian đáng kể</h3>
						<p>
							Khi doanh nghiệp áp dụng quy trình này, doanh nghiệp giảm được thời gian đáng kể khi không
							còn mất nhiều thời gian tìm kiếm đồ dùng, máy móc cần sử dụng trong quá trình làm việc. Khi
							mọi thứ đều có trật tự, mọi sự tìm kiếm đều trở nên dễ dàng.
						</p>
					</>
				),
			},
			{
				...
				content: (
					<>
						<h3>3.3 Tăng năng suất làm việc</h3>
						<p>
			...
			},
			{
				...
				content: (
					<>
						<h3>3.5 Tăng chất lượng sản phẩm</h3>
						<p>
	...
	},
	{
		...
		content: (
			<>
				<figure className="image">
					<img src="/images/news-detail-3.jpg" alt="" />
		...
		listSub: [
			{
				...
				content: (
					<>
						...
						<p>
							Bước đầu tiên trong quy trình là Seiri, mang nghĩa là ngăn nắp, nhằm tổ chức và loại bỏ
							những thứ dư thừa, không cần thiết để tạo ra một không gian làm việc sạch sẽ, gọn gàng và
							tiết kiệm thời gian.
						</p>
					</>
				),
			},
			{
				...
				content: (
					<>
						...
						<p>
							Chữ S thứ 2 là Seiton, có nghĩa là sắp xếp các dụng cụ, thiết bị, tài liệu trong doanh
							nghiệp một cách gọn gàng để giúp tìm kiếm và sử dụng chúng một cách dễ dàng.
						</p>
					</>
				),
			},
			...
			},
			{
				...
				content: (
					<>
						...
						<p>
							Đây được xem là bước cuối cùng trong quy trình. Và bước này đóng vai trò quan trọng trong
							duy trì tính hiệu quả của quy tắc 5S trong dài hạn. Bước này đòi hỏi việc tạo ra một hệ
							thống kỷ luật và giám sát chặt chẽ để đảm bảo mọi người trong tổ chức duy trì và tuân thủ
							theo quy trình.
						</p>
					</>
				),
	...
	},
	{
		...
		content: (
			<>
				<figure className="image">
					<img src="/images/news-detail-5.jpg" alt="" />
					<figcaption>Các bước thực hiện quy trình 5s</figcaption>
				</figure>
				<h2>5. Quy trình được thực hiện như sau:</h2>
				<p>
					Có thể nói quy trình được áp dụng rộng rãi tại các doanh nghiệp trên toàn thế giới, bao gồm cả Việt
					Nam. Điều này càng chứng minh rõ nét tính hiệu quả của quy trình đem lại. Sau đây là các lý do vì
					sao bạn nên lựa chọn quy trình:
		...
		listSub: [
			{
				...
				content: (
					<>
						<h3>5.1 Giai đoạn chuẩn bị</h3>
						<p>
							Trong giai đoạn chuẩn bị, doanh nghiệp cần bố trí nhân lực đứng ra điều hành và quản lý quá
							trình thực hiện quy trình 5S. Việc phân bổ cụ thể như vậy sẽ giúp quá trình áp dụng quy tắc
							5S sẽ hiệu quả hơn.
						</p>
					</>
				),
			...
			},
			{
				...
				content: (
					<>
						<h3>5.3 Thực hiện vệ sinh toàn bộ doanh nghiệp</h3>
						<p>
			...
			},
			{
				...
				content: (
					<>
						<h3>5.4 Sàng lọc, sắp xếp và đánh giá</h3>
						<p>
							Đây là bước tiếp theo sau khi đã hoàn thành bước vệ sinh toàn bộ doanh nghiệp. Doanh nghiệp
							cần đưa ra tiêu chuẩn rõ ràng để việc thực hiện sàng lọc và sắp xếp trở nên khoa học hơn,
							hiệu quả hơn và dễ dàng tìm kiếm sau này.{' '}
						</p>
					</>
				),
			},
			{
				...
				content: (
					<>
						<h3>5.5 Đánh giá</h3>
						<p>
							Sau khi đã hoàn tất các bước, doanh nghiệp nên tổng kết lại quá trình cải tiến và xem xét
							cần cải tiến phương diện nào hay không trong quá trình thực hiện quy trình 5S.
						</p>
					</>
				),
			},
	...
	},
	{
		...
		content: (
			<>
				<h2>6. Quy trình 5S có giống với Kaizen?</h2>
				<p>
					Vậy câu hỏi đặt ra ở đây là quy trình 5S có giống với Kaizen hay không? Quy trình 5S với Kaizen là 2
					khái niệm khác nhau nhưng giữa chúng có mối quan hệ chặt chẽ với nhau.
				</p>
				<p className="contentBorder">
					Về Kaizen, thì đây được xem là một triết lý cải tiến liên tục trong doanh nghiệp. Phương pháp này
					nhằm tạo ra sự thay đổi tích cực, mang tính liên tục và bền vững.
				</p>
				<p className="contentBorder">
					Còn đối với quy tắc 5S, đây là một phương pháp quản lý và cải tiến trong sản xuất. 5S tập trung vào
					việc sắp xếp, sạch sẽ, sắp đặt, tiêu chuẩn hóa và kỷ luật trong môi trường làm việc.
				</p>
				<p>
					Tuy nhiên, quy trình 5S được xem là một phần của Kaizen. Và quy tắc này đóng vai trò quan trọng
					trong việc tạo ra môi trường làm việc sạch sẽ, an toàn. Quy tắc 5S thường được sử dụng làm bước đầu
					tiên trong quá trình cải tiến liên tục của phương pháp Kaizen để tạo ra một nền tảng vững chắc cho
	...
	},
	{
		...
		content: (
			<>
				<h2>7. Đối tượng nào nên áp dụng 5S?</h2>
				<p>
	...
	},
	{
		...
		content: (
			<>
				...
				<h2>8. Các yếu tố tạo nên thành công cho quy trình 5S</h2>
				<p>
					Và những nhân tố quyết định đến quá trình thành công của quy trình nhằm cải tiến môi trường làm việc
					của doanh nghiệp đó là từ phía:
				</p>
				<ul>
					<li>
				...
				<p>
					Đồng thời, trên đây là các yếu tố tạo nên sự thành công nhưng cũng là các lưu ý cho mỗi doanh nghiệp
					cần nắm bắt trước khi bắt tay vào triển khai quy trình 5S vào doanh nghiệp của mình. Và với những
					thông tin bổ ích như trên, FOSO mong rằng phần nào giúp được doanh nghiệp của bạn phát triển, cải
					tiến vượt bậc trong tương lai.
				</p>
			</>
		),
	},
